Python gives you several ways to build record-like objects, but they do not have the same runtime shape or API implications. The meaningful axes are tuple compatibility, mutability, memory layout, generated behavior, and how much future evolution pressure the type can tolerate.
