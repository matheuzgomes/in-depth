...
[The language reference](https://docs.python.org/3/reference/expressions.html#await) defines `await` in terms of the awaitable protocol. In practice, the main awaitables you touch in application code are:
...
- `async` / `await` syntax: Python 3.5+ [PEP 492](https://peps.python.org/pep-0492/)
