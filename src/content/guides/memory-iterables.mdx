...
- [Iterator protocol docs](https://docs.python.org/3/library/stdtypes.html#iterator-types)
- [Generator function reference](https://docs.python.org/3/reference/expressions.html#yield-expressions)
