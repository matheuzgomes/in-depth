[`asyncio`](https://docs.python.org/3/library/asyncio.html) is Python's cooperative concurrency framework for I/O-bound work. It does not make CPU-bound Python code parallel by itself; it lets one thread keep making progress while tasks are waiting.
