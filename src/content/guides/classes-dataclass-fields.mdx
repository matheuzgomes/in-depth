...
Dataclasses were added in Python 3.7 [PEP 557](https://peps.python.org/pep-0557/). `slots=True` and `match_args=True` were added in Python 3.10. `weakref_slot=True` was added in Python 3.11, and the docs require it to be paired with `slots=True`. Current project guidance targets Python 3.10-3.14. Python 3.9 and below are End-of-Life.
